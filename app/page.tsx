...
export default async function Home() {
  ...
  return <main className="min-h-screen bg-zinc-950 text-white"><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(websiteJsonLd) }} />
    ...
    {products.length > 0 ? <ProductCatalog products={products} erliPrices={{}} /> : <section className="bg-white px-4 py-16 text-center text-zinc-600 sm:px-6 sm:py-20">Nie udało się obecnie pobrać aktywnych ofert Allegro.</section>}
