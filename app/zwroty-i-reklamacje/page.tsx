...
export const metadata: Metadata = {
  ...
  description: "Informacje Widia.tech dotyczące zwrotów, reklamacji oraz 2-letniej gwarancji.",
  ...
  return (
    <main className="min-h-screen bg-zinc-100 px-4 py-8 text-zinc-950 sm:px-6 sm:py-12">
      <article className="mx-auto max-w-4xl rounded-3xl bg-white p-6 shadow-sm sm:p-10">
        ...
        <p className="mt-3 leading-7 text-zinc-700">Widia.tech umożliwia zwrot towaru w terminie 30 dni od dnia jego otrzymania. Uprawnienie to nie ogranicza praw przysługujących konsumentowi na podstawie obowiązujących przepisów. W przypadku zakupów dokonanych przez Allegro lub ERLI zwrot można również zgłosić za pośrednictwem panelu danego zamówienia.</p>
        ...
        <p className="mt-3 leading-7 text-zinc-700">Na produkty Widia.tech udzielamy 2-letniej gwarancji. Okres gwarancji jest taki sam niezależnie od tego, czy produkt został zakupiony przez konsumenta do użytku prywatnego, czy przez przedsiębiorcę do celów związanych z działalnością gospodarczą.</p>
